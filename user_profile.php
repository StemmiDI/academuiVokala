...
$sql = "
    ...
    ORDER BY 
        c.name_course,  -- Сортировка по названию курса
        FIELD(s.day_of_week, 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье'),  -- Сортировка по дням недели
        s.time  -- Сортировка по времени
";
